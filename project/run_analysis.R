...
#
# Reference:
#  Reshaping Data - http://www.statmethods.net/management/reshape.html
...
# parameter:
#       dataSetOuputFileName: (character) set the output file name

getCleanHARDataset <- function(dataSetOuputFileName="cleanHAR.txt"){
    ...
    dsWithAvgVars = dcast(molten, activity + subjectID ~ variable, mean) #cast the melted data
